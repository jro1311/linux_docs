...
case "$OS" in
    ...
    "ubuntu")
        # Update aliases
        cat $HOME/Documents/linux_docs/configs/aliases/aliases_ubuntu.md >> $HOME/.bashrc
        ;;
    "linuxmint")
        # Update aliases
    ...
    "opensuse")
        # Update aliases
        cat $HOME/Documents/linux_docs/configs/aliases/aliases_opensuse.md >> $HOME/.bashrc
        ;;
    *)
        case "$OS_LIKE" in
            "arch")
