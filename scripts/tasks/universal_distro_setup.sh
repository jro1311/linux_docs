...
if ask_for_confirmation "Install multimedia codecs?"; then
    ...
    chmod +x "$HOME/Documents/linux_docs/scripts/packages/terminal/install_codecs.sh"
    "$HOME/Documents/linux_docs/scripts/packages/terminal/install_codecs.sh"
...
EOF
    ...
    "rpm-ostree")
        ...
        chmod +x "$HOME/Documents/linux_docs/scripts/packages/customization/install_fonts_microsoft_fedora_atomic.sh"
        "$HOME/Documents/linux_docs/scripts/packages/customization/install_fonts_microsoft_fedora_atomic.sh"
        ;;
    *)
...
if ask_for_confirmation "Install gaming packages?"; then
    ...
    chmod +x "$HOME/Documents/linux_docs/scripts/packages/graphical/install_gaming_meta.sh"
    "$HOME/Documents/linux_docs/scripts/packages/graphical/install_gaming_meta.sh"
