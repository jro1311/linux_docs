...
# Installs package(s)
sudo dnf install -y btop cabextract cpu-x curl dos2unix fastfetch flatpak fontconfig fzf google-noto-sans-jp-fonts google-noto-sans-kr-fonts git gnome-disk-utility gsmartcontrol hplip htop inxi memtest86+ nano pciutils shellcheck smartmontools tealdeer xorg-x11-font-utils yt-dlp zram-generator
