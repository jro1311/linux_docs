...
# Installs package(s)
sudo pacman -Syu --needed --noconfirm btop cpu-x curl discord fastfetch flatpak fzf gsmartcontrol hplip htop libreoffice-fresh memtest86+ mpv smartmontools tealdeer yt-dlp zram-generator
...
cat $HOME/Documents/linux_docs/configs/aliases/aliases_arch.md >> $HOME/.bashrc
