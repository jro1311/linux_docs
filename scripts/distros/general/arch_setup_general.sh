...
# Installs package(s)
sudo pacman -Syu --needed --noconfirm btop cpu-x curl fastfetch flatpak fontconfig fzf gsmartcontrol hplip htop libreoffice-fresh memtest86+ mpv smartmontools tealdeer yt-dlp zram-generator
